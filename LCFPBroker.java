...
public class LCFPBroker extends DatacenterBroker {

    public LCFPBroker(String name) throws Exception {
        super(name);
    }
    ...
    protected void submitCloudlets() {
        ...
        for (Vm vm : vmList) {
            vmNextAvailableTime.put(vm.getId(), 0.0); // all VMs free at time 0
        }
        ...
        System.out.println("========== LCFP Scheduling Completed ==========\n");
    }
}
